...
public class MailerComponent {
	...
	public void send(String para, String asunto, String template, Map<String, Object> mapVariable) throws MessagingException {
		send(para, asunto, template, mapVariable, null);
	}
	
	public void send(String para, String asunto, String template, Map<String, Object> mapVariable, List<ClassPathResource> lstFiles) throws MessagingException {
