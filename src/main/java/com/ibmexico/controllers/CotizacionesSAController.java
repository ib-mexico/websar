...
@Controller
@RequestMapping("controlPanel/Sa")
public class CotizacionesSAController{
    ...
    public ModelAndView index() {
		...
		ModelAndView objModelAndView = modelAndViewComponent.createModelAndViewControlPanel(Templates.CONTROL_PANEL_COTIZACIONES_INDEX_SA);
	...
	@RequestMapping(value = "/tableSA", method = RequestMethod.POST)	
	public @ResponseBody String tableSA(	@RequestParam("offset") int offset,
		...
		DataTable<CotizacionEntity> dtCotizaciones = cotizacionService.dataTableSA(search, offset, limit, txtBootstrapTableDesde, txtBootstrapTableHasta);
