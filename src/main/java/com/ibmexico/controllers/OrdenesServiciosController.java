...
public class OrdenesServiciosController {
    ...
    public @ResponseBody String table(  @RequestParam("offset") int offset,
        ...
        DataTable<OrdenServicioEntity> dtOrdenes=ordenServicioService.dataTableOrdenes(search, offset, limit, txtBootstrapTableDesde, txtBootstrapTableHasta);
    ...
    public ModelAndView create() {
		...
		ModelAndView objModelAndView = modelAndViewComponent.createModelAndViewControlPanel(Templates.CONTROL_PANEL_ORDENES_SERVICIOS_CREATE);
    ...
    public ModelAndView revision(@PathVariable("paramIdOrdenServicio")int paramIdOrdenServicio){
		...
		ModelAndView objModelAndView = modelAndViewComponent.createModelAndViewControlPanel(Templates.CONTROL_PANEL_ORDENES_SERVICIOS_REVIEW);
    ...
    @RequestMapping(value = {"{paramIdOrdenServicio}/pdf", "/{paramIdOrdenServicio}/pdf/"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_PDF_VALUE)
	public ResponseEntity<InputStreamResource> previewPdf(
        ...
        /**El objCotizacion se  reutilizo para evitar modificar el reporte de ordenesServicio 
         * en vez de eso se hace uso del objUser para acceder a las propiedades de la empresa.*/
