...
public class BienDetalleMantenimientoService{
    ...
    public JsonObject jsonBienDetalleMantId(int idDetalleMantenimiento){
        ...
        jsonRows.add(Json.createObjectBuilder()
            ...
            .add("nombre_bien_activo", lstBienDetalleMant.getBienActivo().getNumeroEconomico())
            ...
            .add("nombre_tipo_activo",lstBienDetalleMant.getBienActivo().getIdActivo().getNombre())
